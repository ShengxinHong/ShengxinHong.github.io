...
social:
  - icon: envelope
    icon_pack: fas
    link: 'mailto:seikin.shengxinhong@gmail.com'
  - icon: graduation-cap # Alternatively, use `google-scholar` icon from `ai` icon pack
    icon_pack: fas
    link: https://scholar.google.com/citations?user=14K4m28AAAAJ&hl=zh-CN
  # - icon: github
  #   icon_pack: fab
...
- [**On Modeling Multi-Criteria Decision Making with Uncertain Information using Probabilistic Rules**](https://arxiv.org/abs/2404.13419) [*Preprint Paper*]
